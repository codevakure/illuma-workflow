      ...
      try {
        ...
        if (result.success && result.stream) {
          ...
          if (result.status === 401) {
            errorContent =
              '_Unauthorized request. You need a valid API key to use the copilot. You can get one by going to [illuma.ai](https://illuma.ai) settings and generating one there._'
            ...
            errorContent =
              '_Please upgrade to the latest version of the Illuma platform to continue using the copilot._'
