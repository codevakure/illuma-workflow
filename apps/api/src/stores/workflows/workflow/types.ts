/**
 * Server-side stub for workflow types.
 * Copied from the web app, stripped of React/Zustand/reactflow dependencies.
 * Uses the local Edge shim from @/types/reactflow.
 */
...
export interface WorkflowActions {
  ...
  updateBlockName: (
    ...
    success: boolean
    changedSubblocks: Array<{ blockId: string; subBlockId: string; newValue: unknown }>
  }
  ...
  setLoopForEachItems: (loopId: string, items: unknown) => void
