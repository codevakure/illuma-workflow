...
import type { ModelPricing, ProviderDefinition } from './types'
...
export const PROVIDER_DEFINITIONS: Record<string, ProviderDefinition> = {
  openrouter: {
    ...
    defaultModel: '',
    modelPatternStrings: ['^openrouter\\/'],
    iconId: 'openrouter',
    capabilities: {
  ...
  openai: {
    ...
    defaultModel: 'gpt-4o',
    modelPatternStrings: ['^gpt', '^o1', '^text-embedding'],
    iconId: 'openai',
    capabilities: {
      toolUsageControl: true,
    },
  ...
  'azure-anthropic': {
    ...
    modelPatternStrings: ['^azure-anthropic\\/'],
    iconId: 'azure',
    capabilities: {
      toolUsageControl: true,
    },
