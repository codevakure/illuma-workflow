...
export type { ProviderId, ModelPricing, ModelCapabilities, ModelDefinition, ProviderDefinition } from './types'
export {
  getAllModelIds,
  getProviderModels,
  ...
  supportsTemperature as supportsTemperatureHelper,
  getMaxTemperature,
...
export async function executeProviderRequest(
  ...
  // Always attempt BYOK resolution — server env vars should be used
  // even when workspaceId is not provided (e.g., manual execution)
  try {
