...
/**
 * Server-side block icon type.
 * On the client this is a React SVG component; on the server we use a string identifier.
 */
...
/**
 * Server-side option icon type.
 * On the client this is a React component; on the server we use a string identifier.
 */
