/**
 * Raw SVG icon registry for server-rendered marketplace UI.
 * Extracted from apps/web/src/components/icons.tsx
 */

export const iconRegistry: Record<string, string> = {
  A2AIcon: `<svg viewBox='0 0 860 860' fill='none' xmlns='http://www.w3.org/2000/svg'>
  ...
  AhrefsIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1065 1300'>
      <path
        fill-rule='evenodd'
        fill='#ff8800'
  ...
  AirweaveIcon: `<svg width='143' height='143' viewBox='0 0 143 143' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
  ...
  ApifyIcon: `<svg width='200'
      height='200'
      viewBox='0 0 200 200'
      fill='none'
      xmlns='http://www.w3.org/2000/svg'>
      <g clip-path='url(#apify-clipId)'>
        <path
      ...
      <defs>
        <clipPath id='apify-clipId'>
          <rect width='200' height='200' fill='white' />
        </clipPath>
      </defs>
    </svg>`,
  ApolloIcon: `<svg height='26'
      viewBox='0 0 36 36'
      fill='currentColor'
      xmlns='http://www.w3.org/2000/svg'>
      <path
  ...
  ArxivIcon: `<svg id='logomark' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 17.732 24.269'>
      <g id='tiny'>
        <path
  ...
  AsanaIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'>
      <circle cx='18' cy='16' r='4' fill='#F06A6A' />
      <circle cx='6' cy='16' r='4' fill='#F06A6A' />
      <circle cx='12' cy='6.5' r='4' fill='#F06A6A' />
    </svg>`,
  BrowserUseIcon: `<svg version='1.0'
      xmlns='http://www.w3.org/2000/svg'
      width='28'
      height='28'
      viewBox='0 0 150 150'
...
-462 -377 -309 l-46 35 186 163 c211 186 209 185 237 111z' />
  ...
  CalendlyIcon: `<svg viewBox='0 0 512 512'
      xmlns='http://www.w3.org/2000/svg'
      fill-rule='evenodd'
      clip-rule='evenodd'
      stroke-linejoin='round'
  ...
  CirclebackIcon: `<svg width='280'
      height='280'
      viewBox='0 0 280 280'
      fill='none'
      xmlns='http://www.w3.org/2000/svg'
      xmlns:xlink='http://www.w3.org/1999/xlink'>
      <rect width='280' height='280' fill='url(#circleback-patternId)' />
      <defs>
        <pattern id='circleback-patternId' patternContentUnits='objectBoundingBox' width='1' height='1'>
          <use xlinkHref='#circleback-imageId' transform='scale(0.00357143)' />
        </pattern>
        <image
          id='circleback-imageId'
          width='280'
          height='280'
  ...
  ClayIcon: `<svg xmlns='http://www.w3.org/2000/svg' width='40' height='40' viewBox='0 0 400 400'>
      <path
        xmlns='http://www.w3.org/2000/svg'
        fill='#41B9FD'
  ...
  ClerkIcon: `<svg viewBox='0 0 128 128' fill='none' xmlns='http://www.w3.org/2000/svg'>
  ...
  CursorIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 546 546' fill='currentColor'>
  ...
  DatadogIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64'>
      <g fill='currentColor'>
  ...
  DropboxIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 43 40'>
      <path
  ...
  DsPyIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='30 28 185 175' fill='none'>
      <path
        fill='#D34C3F'
        opacity='1.000000'
        stroke='#D34C3F'
...
z' />
  ...
  DuckDuckGoIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='-108 -108 216 216'>
  ...
  DynamoDBIcon: `<svg viewBox='0 0 80 80'
      version='1.1'
      xmlns='http://www.w3.org/2000/svg'
      xmlns:xlink='http://www.w3.org/1999/xlink'>
      <g
  ...
  ElasticsearchIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 128 128'>
      <path
        fill='#343741'
  ...
  ElevenLabsIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      width='876'
      height='876'
      viewBox='0 0 876 876'
      fill='none'>
  ...
  EnrichSoIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 398 394' fill='none'>
      <path
        fill='#5A52F4'
  ...
  FirecrawlIcon: `<svg viewBox='0 0 642 600' xmlns='http://www.w3.org/2000/svg'>
      <path
  ...
  FirefliesIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='-6 -6 68 68'>
      <defs>
        <linearGradient
          id='fireflies-g1'
      ...
      <g>
        <path fill='url(#fireflies-g1)' d='M18.4,0H0v18.3h18.4V0z' />
        <path fill='url(#fireflies-g2)' d='M40.2,22.1H21.8v18.3h18.4V22.1z' />
        <path
          fill='url(#fireflies-g3)'
          d='M40.2,0H21.8v18.3H56v-2.6c0-4.2-1.7-8.1-4.6-11.1C48.4,1.7,44.4,0,40.2,0L40.2,0z' />
        <path
          fill='url(#fireflies-g4)'
          d='M0,22.1v18.3c0,4.2,1.7,8.1,4.6,11.1c3,2.9,7,4.6,11.2,4.6h2.6V22.1H0z' />
        <path fill='url(#fireflies-g5)' opacity='0.18' d='M0,0l18.4,18.3H0V0z' />
        <path fill='url(#fireflies-g6)' opacity='0.18' d='M21.8,22.1l18.4,18.3H21.8V22.1z' />
        <path
          fill='url(#fireflies-g7)'
          opacity='0.18'
          d='M0,40.3c0,4.2,1.7,8.1,4.6,11.1c3,2.9,7,4.6,11.2,4.6h2.6V22.1L0,40.3z' />
        <path
          fill='url(#fireflies-g8)'
          opacity='0.18'
          d='M40.2,0c4.2,0,8.2,1.7,11.2,4.6c3,2.9,4.6,6.9,4.6,11.1v2.6H21.8L40.2,0z' />
      </g>
    </svg>`,
  GitLabIcon: `<svg width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
      <path
  ...
  GithubIcon: `<svg width='26' height='26' viewBox='0 0 26 26' xmlns='http://www.w3.org/2000/svg'>
      <path
  ...
  GmailIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 48 48'
      width='96px'
      height='96px'>
  ...
  GoogleBooksIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 478.633 540.068'>
      <path
        fill='#1C51A4'
  ...
  GoogleCalendarIcon: `<svg version='1.1'
      xmlns='http://www.w3.org/2000/svg'
      xmlns:xlink='http://www.w3.org/1999/xlink'
      x='0px'
      y='0px'
  ...
  GoogleDocsIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 48 48'
      width='96px'
      height='96px'>
      <path
  ...
  GoogleDriveIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 87.3 78'
      width='1em'
      height='1em'>
      <path
  ...
  GoogleFormsIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 65' fill='none'>
      <path
  ...
  GoogleGroupsIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 950 950'>
      <path
  ...
  GoogleIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48' width='24' height='24'>
      <path
        fill='#fbc02d'
  ...
  GoogleMapsIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 92.3 132.3'>
      <path
        fill='#1a73e8'
  ...
  GoogleSheetsIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 48 48'
      width='96px'
      height='96px'>
      <path
  ...
  GoogleSlidesIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 48 48'
      width='96px'
      height='96px'>
      <path
  ...
  GoogleVaultIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 82 82'>
    <path
      xmlns='http://www.w3.org/2000/svg'
  ...
  GrafanaIcon: `<svg width='800px'
      height='800px'
      viewBox='0 0 16 16'
      xmlns='http://www.w3.org/2000/svg'
      fill='none'>
      <path
        fill='url(#grafana-gradientId)'
  ...
  GrainIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 34 34' fill='none'>
      <path
        fill='#00B96C'
  ...
  GreptileIcon: `<svg viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
      <path
        clip-rule='evenodd'
        fill-rule='evenodd'
        fill='#44A775'
  ...
  IncidentioIcon: `<svg width='128'
      height='163'
      viewBox='0 0 128 163'
      fill='none'
      xmlns='http://www.w3.org/2000/svg'>
      <g clip-path='url(#incidentio-clipId)'>
        <path
          fill-rule='evenodd'
          clip-rule='evenodd'
      ...
      <defs>
        <clipPath id='incidentio-clipId'>
          <rect width='128' height='163' fill='white' />
        </clipPath>
      </defs>
    </svg>`,
  IntercomIcon: `<svg width='800px'
      height='800px'
  ...
  JiraIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 30 30'
      width='24'
      height='24'
      focusable='false'
  ...
  JiraServiceManagementIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='-290 -40 580 580'>
      <path
  ...
  KalshiIcon: `<svg viewBox='0 0 78 20' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
  ...
  LangsmithIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 24' fill='none'>
      <path
        fill-rule='evenodd'
        clip-rule='evenodd'
  ...
  LemlistIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 180 181' fill='none'>
      <path
        fill-rule='evenodd'
        clip-rule='evenodd'
  ...
  LinearIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      fill='currentColor'
      width='200'
      height='200'
      viewBox='0 0 100 100'>
  ...
  LinkedInIcon: `<svg fill='currentColor'
      height='72'
      viewBox='0 0 72 72'
      width='72'
      xmlns='http://www.w3.org/2000/svg'>
  ...
  LinkupIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
  ...
  McpIcon: `<svg width='16'
      height='16'
      viewBox='0 0 16 16'
      fill='none'
      xmlns='http://www.w3.org/2000/svg'>
      <g clip-path='url(#mcp-clipId)'>
        <path
          fill-rule='evenodd'
          clip-rule='evenodd'
      ...
      <defs>
        <clipPath id='mcp-clipId'>
          <rect width='16' height='16' fill='white' />
        </clipPath>
      </defs>
    </svg>`,
  Mem0Icon: `<svg width='479'
      height='108'
      viewBox='0 0 108 108'
      fill='none'
      xmlns='http://www.w3.org/2000/svg'>
  ...
  MicrosoftExcelIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      version='1.1'
      id='Livello_1'
      x='0px'
      y='0px'
      ...
      <path
        fill='url(#microsoftexcel-gradientId)'
  ...
  MicrosoftOneDriveIcon: `<svg fill='currentColor' viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg'>
      <g>
        <path
  ...
  MicrosoftPlannerIcon: `<svg viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path
  ...
  MicrosoftSharepointIcon: `<svg fill='currentColor' viewBox='0 0 32 32' xmlns='http://www.w3.org/2000/svg'>
  ...
  MicrosoftTeamsIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 2228.833 2073.333'>
      <path
        fill='#5059C9'
      ...
      <path
        fill='url(#microsoftteams-gradientId)'
  ...
  MistralIcon: `<svg width='22'
      height='22'
      viewBox='1 0.5 24 22'
      fill='none'
      xmlns='http://www.w3.org/2000/svg'
      preserveAspectRatio='xMidYMid meet'>
      <g clip-path='url(#mistral-clipId)'>
      ...
      <defs>
        <clipPath id='mistral-clipId'>
          <rect width='24' height='22' fill='white' />
        </clipPath>
      </defs>
    </svg>`,
  MongoDBIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 128 128'>
      <path
        fill-rule='evenodd'
        clip-rule='evenodd'
        fill='currentColor'
  ...
  MySQLIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      width='64'
      height='64'
  ...
  Neo4jIcon: `<svg viewBox='0 0 128 128' fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
      <path
  ...
  NotionIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 50 50' width='1em' height='1em'>
      <path
  ...
  OnePasswordIcon: `<svg viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg' fill='none'>
      <circle
        cx='24'
        cy='24'
        r='21.5'
  ...
  OutlookIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      version='1.1'
      id='Livello_1'
      x='0px'
      y='0px'
  ...
  PerplexityIcon: `<svg width='1em' height='1em' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
      <path
  ...
  PolymarketIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='51 209 123 155'>
      <path
        fill='currentColor'
  ...
  QdrantIcon: `<svg fill='none' viewBox='0 0 49 56' xmlns='http://www.w3.org/2000/svg'>
      <g clip-path='url(#qdrant-clipPathId)'>
        <path
        ...
        <path
          ...
          fill='url(#qdrant-gradientId)' />
      </g>
      <defs>
        <linearGradient
          id='qdrant-gradientId'
          x1='23.18'
          x2='15.491'
          y1='38.781'
          y2='38.781'
  ...
  STTIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      width='24'
      height='24'
      viewBox='0 0 24 24'
      fill='none'
  ...
  SalesforceIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 273 191'>
      <path
  ...
  SerperIcon: `<svg viewBox='0 0 654 600' xmlns='http://www.w3.org/2000/svg'>
      <path
  ...
  ServiceNowIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 71.1 63.6'>
      <path
        fill-rule='evenodd'
        clip-rule='evenodd'
        fill='#62D84E'
  ...
  SftpIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 32 32'
      width='32px'
      height='32px'>
      <path
  ...
  ShopifyIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 48 48'
      width='48px'
      height='48px'>
      <path
  ...
  SlackIcon: `<svg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'>
      <g>
        <path
  ...
  SpotifyIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 496 512'>
      <path
        fill='#1ed760'
  ...
  SshIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      width='24'
      height='24'
      viewBox='0 0 24 24'
      fill='none'
  ...
  SupabaseIcon: `<svg fill='currentColor'
      width='24'
      height='24'
      viewBox='0 0 27 27'
      xmlns='http://www.w3.org/2000/svg'>
  ...
  TTSIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      width='24'
      height='24'
      viewBox='0 0 24 24'
      fill='none'
  ...
  TavilyIcon: `<svg viewBox='0 0 600 600' xmlns='http://www.w3.org/2000/svg'>
      <path
  ...
  TelegramIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 24 24'
      width='24'
      height='24'
      fill='none'>
  ...
  TextractIcon: `<svg viewBox='10 14 60 52'
      version='1.1'
      xmlns='http://www.w3.org/2000/svg'
      xmlns:xlink='http://www.w3.org/1999/xlink'>
      <path
  ...
  TinybirdIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none'>
  ...
  TranslateIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      width='24'
      height='24'
      viewBox='0 0 24 24'
      fill='none'
  ...
  TrelloIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      width='256'
      height='256'
      viewBox='0 0 256 256'
      preserveAspectRatio='xMidYMid'>
  ...
  TwilioIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='-8 -8 272 272'>
      <path
        fill='currentColor'
  ...
  VideoIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      width='24'
      height='24'
      viewBox='0 0 24 24'
      fill='none'
  ...
  WealthboxIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      version='1.0'
      width='200'
      height='200'
  ...
  WhatsAppIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      width='16'
      height='16'
      fill='currentColor'
      viewBox='0 0 16 16'>
  ...
  WikipediaIcon: `<svg fill='currentColor'
      version='1.1'
      id='Capa_1'
      xmlns='http://www.w3.org/2000/svg'
      xmlns:xlink='http://www.w3.org/1999/xlink'
  ...
  WordpressIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 25.925 25.925'>
      <g fill='currentColor'>
  ...
  ZepIcon: `<svg xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 233 196'
      width='96px'
      height='96px'>
      <path
  ...
  ZoomIcon: `<svg fill='currentColor'
      width='800px'
      height='800px'
      viewBox='0 0 32 32'
      version='1.1'
  ...
  xIcon: `<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 50 50' width='1em' height='1em'>
      <path
